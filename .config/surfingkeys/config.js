...
api.addSearchAlias('b', 'brave', 'https://search.brave.com/search?source=web&q=', 's', 'https://search.brave.com/api/suggest?rich=true&source=web&q=', function(response) {
...
api.addSearchAlias('w', 'qwant', 'https://www.qwant.com/?t=web&q=', 's', 'https://api.qwant.com/v3/suggest?locale=en_GB&q=', function(response) {
    var res = JSON.parse(response.text);
