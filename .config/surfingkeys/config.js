...
addSearchAlias('b', 'brave', 'https://search.brave.com/search?source=web&q=', 's', 'https://search.brave.com/api/suggest?rich=true&source=web&q=', function(response) {
...
addSearchAlias('w', 'qwant', 'https://www.qwant.com/?t=web&q=', 's', 'https://api.qwant.com/v3/suggest?locale=en_GB&q=', function(response) {
    var res = JSON.parse(response.text);
...
// Doom One
Hints.style('border: solid 2px #282C34; color:#C5C8C6; background: initial; background-color: #2E3440;');
...
Visual.style('marks', 'background-color: #E4AF0099;');
